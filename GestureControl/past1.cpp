...
int bmain() {
	...
	VideoCapture capture("C:\\Users\\Matthew\\Desktop\\Camera_Roll\\vlcsnap-error085.png");//("C:\\Users\\Matthew\\Desktop\\Camera_Roll\\WIN_20160427_13_53_54_Pro.mp4");//(0); // connect to a camera
